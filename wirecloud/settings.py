...
# Forces the domain for the plugins to be set to different url.
# https://forge.fiware.org/plugins/mediawiki/wiki/fiware/index.php/Application_Mashup_-_Wirecloud_-_Installation_and_Administration_Guide#FORCE_DOMAIN
# ---
FORCE_DOMAIN = os.environ.get('FORCE_DOMAIN', 'localhost:8080')
